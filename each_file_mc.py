...
def rollout_model(model, scaler, episodes=25):
    ...
    for _ in range(episodes):
        ...
        while not done and steps < 200:  # MountainCar max is usually ~200
        ...
        # success in MountainCar = reaching the flag (usually steps < 200 or reward threshold)
